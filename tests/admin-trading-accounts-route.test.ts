...
function snapshot() { return { serverTime: '2026-07-21T12:00:00Z', clientStatus: 'Active', clientPlan: 'Basic', membership: { storedTier: 'Standard', effectiveTier: 'Standard', status: 'Active', startedAt: null, expiresAt: null }, currentAccount: null, hasRegisteredAccount: false, licensesBound: 0, eligibleLicenses: 1, canChange: true, nextChangeAt: null, cooldownDays: 7, cooldownReason: null, legacyReview: { pendingCount: 0, suggestedAccountNumber: null }, history: [] }; }

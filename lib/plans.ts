...
export const plans: Record<PlanKey, PlanDetails> = {
  basic: {
    ...
    highlights: ['London session', 'Safe risk profile', 'Maximum 2 positions', '7-day live trading dashboard', '7-day P&L calendar'],
  },
  premium: {
    key: 'premium',
    name: 'Premium',
    ...
    highlights: ['London + New York', 'Safe + Balanced profiles', 'Maximum 5 positions', '90-day analytics + advanced metrics', 'Performance breakdowns + CSV export'],
  },
  lifetime: {
    key: 'lifetime',
    name: 'Lifetime',
    ...
    highlights: ['All supported sessions', 'All profiles + Custom', 'Configurable position limit', 'All recorded analytics + advanced metrics', 'All recorded performance + CSV export'],
  },
};
...
const allowedAuthDestinations = new Set(['/portal', '/portal/trading', '/portal/performance', '/portal/profile', '/portal/settings', '/checkout', '/reset-password']);
